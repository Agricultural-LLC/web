...
Repository root. remono合同会社 Webサイト - 人と技術と農業をつなぐプラットフォーム
...
- src/ Astro routes, components, content, and helpers

## Project Context

Generated by `/init-deep`. Hierarchical AGENTS.md helps agents pull only the local guidance they need.
...
- [`functions/AGENTS.md`](./functions/AGENTS.md) - Firebase Functions guidance
- [`src/AGENTS.md`](./src/AGENTS.md) - source tree guidance
- [`src/components/AGENTS.md`](./src/components/AGENTS.md) - UI component guidance
- [`src/lib/AGENTS.md`](./src/lib/AGENTS.md) - helper/library guidance
- [`src/lib/cms/AGENTS.md`](./src/lib/cms/AGENTS.md) - CMS helper guidance
